...
|!["ESP32 Inicialização"](https://github.com/EMendesS/main/img/Board_preview.jpg)|
|:--:|
| *Fig. 1: Top preview* |
|!["ESP32 Inicialização"](https://github.com/EMendesS/main/img/Board_preview_bottom.jpg)|
...
|!["Capacitor Association"](https://github.com/EMendesS/main/img/Capacitor_association.JPG)|
|:--:|
...
|!["Capacitor Placing"](https://github.com/EMendesS/main/img/Capacitor%20placing.JPG)|
|:--:|
...
|!["Capacitor Placing"](https://github.com/EMendesS/main/img/scope_64.png)|
|:--:|
| *Fig. 1: No bulk capacitors added* |

|!["Capacitor Placing"](https://github.com/EMendesS/main/img/scope_66.png)|
|:--:|
...
| <img src="https://github.com/EMendesS/main/img/switching_1.png" width="450" height="280"> |
|:--:|
...
([USB-C connector datasheet](https://github.com/EMendesS/main/img/Global_Connector_Technology_usb4105-3106202.pdf))
...
|!["SPI Pins"](https://github.com/EMendesS/main/img/SPI_ORG_ESP32.png)|
|:--:|
| *Fig. 1: SPI Pins* |
...
|!["FLASH Pinout"](https://github.com/EMendesS/main/img/SPI%20Flash.JPG)|
|:--:|
...
|!["Pinout ESP32"](https://github.com/EMendesS/main/img/Pinout%20ESP32.JPG)|
|:--:|
| *Fig. 1: ESP32 SPI Pinout* |

Consecutively, the pattern as shown in the image below was used:

|!["dominating_sets_example2"](https://github.com/EMendesS/main/img/Tabela%2027%20ESP32%20Technical%20Reference%20Manual.JPG)|
|:--:|
...
|!["ESP32 Inicialização"](https://github.com/EMendesS/main/img/ESP32%20Strapping%20Pins.JPG)|
|:--:|
...
|!["STM32 SPI Organization"](https://github.com/EMendesS/main/img/SPI%20Org.JPG)|
|:--:|
...
|!["I2C Block"](https://github.com/EMendesS/main/img/Esquema%20I2C.JPG)|
|:--:|
| *Fig. 2: I2C Block* |
...
|!["STM32 I2C Organization"](https://github.com/EMendesS/main/img/LQFP64%20I2C%20Pins.png)|
|:--:|
...
|!["Boot Modes"](https://github.com/EMendesS/main/img/Boot%20Table.JPG)|
|:--:|
| *Fig. 1: Boot Modes* |
...
|!["Microstrip"](https://github.com/EMendesS/main/img/microstrip_via_study4.png)|
|:--:|
| *Fig. 2: TIMERs* |

Some times few vias between two microstrips can improve signal integrity, compered to a no-via fencing, as shown below:
|!["Microstrip"](https://github.com/EMendesS/main/img/microstrip_via_study5.png)|
|:--:|
| *Fig. 2: TIMERs* |

***
# 1.4 PINOUT
|!["TIMERs"](https://github.com/EMendesS/main/img/Timer%20Pins.jpg)|
|:--:|
| *Fig. 2: TIMERs* |
